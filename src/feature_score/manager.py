...
def calc_scores(features, n):
    ...
    result_lap_score_standardized = (1 - (result_lap_score - min_lap_score) / range_lap_score)
    standardized.append(result_lap_score_standardized)
    ...
    result_mcfs_standardized = (result_mcfs - min_mcfs) / range_mcfs
    standardized.append(result_mcfs_standardized)
    ...
    result_ndfs_standardized = 1 - (result_ndfs - min_ndfs) / range_ndfs
    standardized.append(result_ndfs_standardized)
    ...
    result_udfs_standardized = (result_udfs - min_udfs) / range_udfs
    standardized.append(result_udfs_standardized)
